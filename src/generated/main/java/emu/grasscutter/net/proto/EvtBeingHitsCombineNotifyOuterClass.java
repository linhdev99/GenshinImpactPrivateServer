...
public final class EvtBeingHitsCombineNotifyOuterClass {
  ...
  public interface EvtBeingHitsCombineNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .EvtBeingHitInfo evt_being_hit_info_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum CmdId
       ...
       * <code>CMD_ID = 375;</code>
       */
      public static final int CMD_ID_VALUE = 375;
    ...
    public static final int EVT_BEING_HIT_INFO_LIST_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < evtBeingHitInfoList_.size(); i++) {
        output.writeMessage(2, evtBeingHitInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < evtBeingHitInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, evtBeingHitInfoList_.get(i));
      }
