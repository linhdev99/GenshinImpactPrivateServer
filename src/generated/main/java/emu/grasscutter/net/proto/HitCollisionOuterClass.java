...
public final class HitCollisionOuterClass {
  ...
  public interface HitCollisionOrBuilder extends
    ...
    /**
     * <code>.HitColliderType hit_collider_type = 1;</code>
    ...
    /**
     * <code>float attackee_hit_entity_angle = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int HIT_COLLIDER_TYPE_FIELD_NUMBER = 1;
    ...
    public static final int ATTACKEE_HIT_ENTITY_ANGLE_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (hitColliderType_ != emu.grasscutter.net.proto.HitColliderTypeOuterClass.HitColliderType.HIT_COLLIDER_INVALID.getNumber()) {
        output.writeEnum(1, hitColliderType_);
      }
      if (hitBoxIndex_ != 0) {
      ...
      if (attackeeHitEntityAngle_ != 0F) {
        output.writeFloat(6, attackeeHitEntityAngle_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (hitColliderType_ != emu.grasscutter.net.proto.HitColliderTypeOuterClass.HitColliderType.HIT_COLLIDER_INVALID.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(1, hitColliderType_);
      }
      if (hitBoxIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (attackeeHitEntityAngle_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(6, attackeeHitEntityAngle_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t_collider_type\030\001 \001(\0162\020.HitColliderType\022" +
      "\025\n\rhit_box_index\030\002 \001(\005\022\032\n\thit_point\030\003 \001(" +
      "\0132\007.Vector\022\030\n\007hit_dir\030\004 \001(\0132\007.Vector\022 \n\030" +
      "attackee_hit_force_angle\030\005 \001(\002\022!\n\031attack" +
      "ee_hit_entity_angle\030\006 \001(\002B\033\n\031emu.grasscu" +
