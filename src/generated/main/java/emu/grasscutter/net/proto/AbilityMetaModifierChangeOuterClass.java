...
public final class AbilityMetaModifierChangeOuterClass {
  ...
  public interface AbilityMetaModifierChangeOrBuilder extends
    ...
    /**
     * <code>.AbilityAttachedModifier attached_instanced_modifier = 4;</code>
    ...
    /**
     * <code>repeated .ModifierProperty properties = 5;</code>
     */
    ...
    /**
     * <code>int32 modifier_local_id = 6;</code>
     * @return The modifierLocalId.
     */
    int getModifierLocalId();

    /**
     * <code>bool is_mute_remote = 7;</code>
    ...
    /**
     * <code>bool is_attached_parent_ability = 9;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ATTACHED_INSTANCED_MODIFIER_FIELD_NUMBER = 4;
    ...
    public static final int MODIFIER_LOCAL_ID_FIELD_NUMBER = 6;
    ...
    public static final int IS_MUTE_REMOTE_FIELD_NUMBER = 7;
    ...
    public static final int IS_ATTACHED_PARENT_ABILITY_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (attachedInstancedModifier_ != null) {
        output.writeMessage(4, getAttachedInstancedModifier());
      }
      ...
      if (isMuteRemote_ != false) {
        output.writeBool(7, isMuteRemote_);
      }
      if (applyEntityId_ != 0) {
        output.writeUInt32(8, applyEntityId_);
      }
      if (isAttachedParentAbility_ != false) {
        output.writeBool(9, isAttachedParentAbility_);
      }
      if (serverBuffUid_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (attachedInstancedModifier_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, getAttachedInstancedModifier());
      }
      for (int i = 0; i < properties_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (isMuteRemote_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(7, isMuteRemote_);
      }
      if (applyEntityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (isAttachedParentAbility_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(9, isAttachedParentAbility_);
      }
      if (serverBuffUid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\037AbilityMetaModifierChange.proto\032\024Modif" +
      "ierAction.proto\032\023AbilityString.proto\032\035Ab" +
      "ilityAttachedModifier.proto\032\026ModifierPro" +
      "perty.proto\"\211\003\n\031AbilityMetaModifierChang" +
      "e\022\037\n\006action\030\001 \001(\0162\017.ModifierAction\022+\n\023pa" +
      "rent_ability_name\030\002 \001(\0132\016.AbilityString\022" +
      "/\n\027parent_ability_override\030\003 \001(\0132\016.Abili" +
      "tyString\022=\n\033attached_instanced_modifier\030" +
      "\004 \001(\0132\030.AbilityAttachedModifier\022%\n\nprope" +
      "rties\030\005 \003(\0132\021.ModifierProperty\022\031\n\021modifi" +
      "er_local_id\030\006 \001(\005\022\026\n\016is_mute_remote\030\007 \001(" +
      "\010\022\027\n\017apply_entity_id\030\010 \001(\r\022\"\n\032is_attache" +
      "d_parent_ability\030\t \001(\010\022\027\n\017server_buff_ui" +
    ...
    internal_static_AbilityMetaModifierChange_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AbilityMetaModifierChange_descriptor,
        new java.lang.String[] { "Action", "ParentAbilityName", "ParentAbilityOverride", "AttachedInstancedModifier", "Properties", "ModifierLocalId", "IsMuteRemote", "ApplyEntityId", "IsAttachedParentAbility", "ServerBuffUid", });
    emu.grasscutter.net.proto.ModifierActionOuterClass.getDescriptor();
    emu.grasscutter.net.proto.AbilityStringOuterClass.getDescriptor();
    emu.grasscutter.net.proto.AbilityAttachedModifierOuterClass.getDescriptor();
    emu.grasscutter.net.proto.ModifierPropertyOuterClass.getDescriptor();
