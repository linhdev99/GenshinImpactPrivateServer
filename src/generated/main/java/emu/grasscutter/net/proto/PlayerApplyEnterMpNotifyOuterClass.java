...
public final class PlayerApplyEnterMpNotifyOuterClass {
  ...
  public interface PlayerApplyEnterMpNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 src_app_id = 2;</code>
     * @return The srcAppId.
     */
    int getSrcAppId();

    /**
     * <code>uint32 src_thread_index = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SRC_APP_ID_FIELD_NUMBER = 2;
    ...
    public static final int SRC_THREAD_INDEX_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (srcPlayerInfo_ != null) {
        output.writeMessage(1, getSrcPlayerInfo());
      }
      if (srcAppId_ != 0) {
        output.writeUInt32(2, srcAppId_);
      }
      if (srcThreadIndex_ != 0) {
        output.writeUInt32(3, srcThreadIndex_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (srcPlayerInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, getSrcPlayerInfo());
      }
      if (srcAppId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, srcAppId_);
      }
      if (srcThreadIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, srcThreadIndex_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "otify\022*\n\017src_player_info\030\001 \001(\0132\021.OnlineP" +
      "layerInfo\022\022\n\nsrc_app_id\030\002 \001(\r\022\030\n\020src_thr" +
      "ead_index\030\003 \001(\r\"M\n\005CmdId\022\010\n\004NONE\020\000\022\023\n\017EN" +
