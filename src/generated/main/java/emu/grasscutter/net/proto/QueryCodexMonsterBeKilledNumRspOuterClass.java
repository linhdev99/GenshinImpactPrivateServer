...
public final class QueryCodexMonsterBeKilledNumRspOuterClass {
  ...
  public interface QueryCodexMonsterBeKilledNumRspOrBuilder extends
    ...
    /**
     * <code>repeated uint32 be_killed_num_list = 3;</code>
    ...
    /**
     * <code>repeated uint32 be_killed_num_empty_list = 4;</code>
     * @return A list containing the beKilledNumEmptyList.
     */
    java.util.List<java.lang.Integer> getBeKilledNumEmptyListList();
    /**
     * <code>repeated uint32 be_killed_num_empty_list = 4;</code>
     * @return The count of beKilledNumEmptyList.
     */
    int getBeKilledNumEmptyListCount();
    /**
     * <code>repeated uint32 be_killed_num_empty_list = 4;</code>
     * @param index The index of the element to return.
     * @return The beKilledNumEmptyList at the given index.
     */
    int getBeKilledNumEmptyList(int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private QueryCodexMonsterBeKilledNumRsp() {
      ...
      beKilledNumEmptyList_ = emptyIntList();
    }
    ...
    private QueryCodexMonsterBeKilledNumRsp(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 32: {
              if (!((mutable_bitField0_ & 0x00000004) != 0)) {
                beKilledNumEmptyList_ = newIntList();
                mutable_bitField0_ |= 0x00000004;
              }
              beKilledNumEmptyList_.addInt(input.readUInt32());
              break;
            }
            case 34: {
              int length = input.readRawVarint32();
        ...
        if (((mutable_bitField0_ & 0x00000004) != 0)) {
          beKilledNumEmptyList_.makeImmutable(); // C
        }
    ...
    public static final int BE_KILLED_NUM_LIST_FIELD_NUMBER = 3;
    ...
    public static final int BE_KILLED_NUM_EMPTY_LIST_FIELD_NUMBER = 4;
    private com.google.protobuf.Internal.IntList beKilledNumEmptyList_;
    /**
     * <code>repeated uint32 be_killed_num_empty_list = 4;</code>
     * @return A list containing the beKilledNumEmptyList.
     */
    @java.lang.Override
    public java.util.List<java.lang.Integer>
        getBeKilledNumEmptyListList() {
      return beKilledNumEmptyList_;
    }
    /**
     * <code>repeated uint32 be_killed_num_empty_list = 4;</code>
     * @return The count of beKilledNumEmptyList.
     */
    public int getBeKilledNumEmptyListCount() {
      return beKilledNumEmptyList_.size();
    }
    /**
     * <code>repeated uint32 be_killed_num_empty_list = 4;</code>
     * @param index The index of the element to return.
     * @return The beKilledNumEmptyList at the given index.
     */
    public int getBeKilledNumEmptyList(int index) {
      return beKilledNumEmptyList_.getInt(index);
    }
    private int beKilledNumEmptyListMemoizedSerializedSize = -1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (getBeKilledNumEmptyListList().size() > 0) {
        output.writeUInt32NoTag(34);
        output.writeUInt32NoTag(beKilledNumEmptyListMemoizedSerializedSize);
      }
      for (int i = 0; i < beKilledNumEmptyList_.size(); i++) {
        output.writeUInt32NoTag(beKilledNumEmptyList_.getInt(i));
      }
    ...
    public int getSerializedSize() {
      ...
      }
      {
        ...
        for (int i = 0; i < beKilledNumEmptyList_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(beKilledNumEmptyList_.getInt(i));
        }
        size += dataSize;
        if (!getBeKilledNumEmptyListList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        beKilledNumEmptyListMemoizedSerializedSize = dataSize;
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getBeKilledNumEmptyListList()
          .equals(other.getBeKilledNumEmptyListList())) return false;
    ...
    public int hashCode() {
      ...
      if (getBeKilledNumEmptyListCount() > 0) {
        hash = (37 * hash) + BE_KILLED_NUM_EMPTY_LIST_FIELD_NUMBER;
        hash = (53 * hash) + getBeKilledNumEmptyListList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.QueryCodexMonsterBeKilledNumRspOuterClass.QueryCodexMonsterBeKilledNumRsp buildPartial() {
        ...
        if (((bitField0_ & 0x00000004) != 0)) {
          beKilledNumEmptyList_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000004);
        }
        result.beKilledNumEmptyList_ = beKilledNumEmptyList_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.QueryCodexMonsterBeKilledNumRspOuterClass.QueryCodexMonsterBeKilledNumRsp other) {
        ...
        if (!other.beKilledNumEmptyList_.isEmpty()) {
          if (beKilledNumEmptyList_.isEmpty()) {
            beKilledNumEmptyList_ = other.beKilledNumEmptyList_;
            bitField0_ = (bitField0_ & ~0x00000004);
          } else {
            ensureBeKilledNumEmptyListIsMutable();
            beKilledNumEmptyList_.addAll(other.beKilledNumEmptyList_);
          }
          onChanged();
        }
      ...
      private com.google.protobuf.Internal.IntList beKilledNumEmptyList_ = emptyIntList();
      private void ensureBeKilledNumEmptyListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          beKilledNumEmptyList_ = mutableCopy(beKilledNumEmptyList_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000004) != 0) ?
                 java.util.Collections.unmodifiableList(beKilledNumEmptyList_) : beKilledNumEmptyList_;
      }
      /**
       * <code>repeated uint32 be_killed_num_empty_list = 4;</code>
       * @return The count of beKilledNumEmptyList.
       ...
       * <code>repeated uint32 be_killed_num_empty_list = 4;</code>
       * @param index The index to set the value at.
       * @param value The beKilledNumEmptyList to set.
       * @return This builder for chaining.
       */
      public Builder setBeKilledNumEmptyList(
          int index, int value) {
        ensureBeKilledNumEmptyListIsMutable();
        beKilledNumEmptyList_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 be_killed_num_empty_list = 4;</code>
       * @param value The beKilledNumEmptyList to add.
       * @return This builder for chaining.
       */
      public Builder addBeKilledNumEmptyList(int value) {
        ensureBeKilledNumEmptyListIsMutable();
        beKilledNumEmptyList_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 be_killed_num_empty_list = 4;</code>
       * @param values The beKilledNumEmptyList to add.
       * @return This builder for chaining.
       */
      public Builder addAllBeKilledNumEmptyList(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureBeKilledNumEmptyListIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, beKilledNumEmptyList_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearBeKilledNumEmptyList() {
        beKilledNumEmptyList_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000004);
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "etcode\030\001 \001(\005\022\025\n\rcodex_id_list\030\002 \003(\r\022\032\n\022b" +
      "e_killed_num_list\030\003 \003(\r\022 \n\030be_killed_num" +
      "_empty_list\030\004 \003(\r\"M\n\005CmdId\022\010\n\004NONE\020\000\022\023\n\017" +
    ...
    internal_static_QueryCodexMonsterBeKilledNumRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_QueryCodexMonsterBeKilledNumRsp_descriptor,
        new java.lang.String[] { "Retcode", "CodexIdList", "BeKilledNumList", "BeKilledNumEmptyList", });
  }
