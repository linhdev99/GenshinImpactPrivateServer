...
public final class CombatInvokeEntryOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int COMBAT_DATA_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!combatData_.isEmpty()) {
        output.writeBytes(3, combatData_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!combatData_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(3, combatData_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "InvokeEntry\022*\n\rargument_type\030\001 \001(\0162\023.Com" +
      "batTypeArgument\022\"\n\014forward_type\030\002 \001(\0162\014." +
      "ForwardType\022\023\n\013combat_data\030\003 \001(\014B\033\n\031emu." +
