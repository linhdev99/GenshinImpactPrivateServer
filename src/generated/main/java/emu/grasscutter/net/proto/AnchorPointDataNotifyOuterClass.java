...
public final class AnchorPointDataNotifyOuterClass {
  ...
  public interface AnchorPointDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .AnchorPointData anchor_point_list = 1;</code>
     */
    ...
    /**
     * <code>uint32 next_usable_time = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    /**
     * Protobuf enum {@code AnchorPointDataNotify.CmdId}
     */
    public enum CmdId
       ...
       * <code>CMD_ID = 4253;</code>
       */
      public static final int CMD_ID_VALUE = 4253;
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.proto.AnchorPointDataNotifyOuterClass.AnchorPointDataNotify.getDescriptor().getEnumTypes().get(0);
      }
      ...
      // @@protoc_insertion_point(enum_scope:AnchorPointDataNotify.CmdId)
    }

    public static final int ANCHOR_POINT_LIST_FIELD_NUMBER = 1;
    ...
    public static final int NEXT_USABLE_TIME_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < anchorPointList_.size(); i++) {
        output.writeMessage(1, anchorPointList_.get(i));
      }
      if (nextUsableTime_ != 0) {
        output.writeUInt32(2, nextUsableTime_);
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < anchorPointList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, anchorPointList_.get(i));
      }
      if (nextUsableTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, nextUsableTime_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ntData.proto\"\255\001\n\025AnchorPointDataNotify\022+" +
      "\n\021anchor_point_list\030\001 \003(\0132\020.AnchorPointD" +
      "ata\022\030\n\020next_usable_time\030\002 \001(\r\"M\n\005CmdId\022\010" +
      "\n\004NONE\020\000\022\023\n\017ENET_CHANNEL_ID\020\000\022\024\n\020ENET_IS" +
      "_RELIABLE\020\001\022\013\n\006CMD_ID\020\235!\032\002\020\001B\033\n\031emu.gras" +
