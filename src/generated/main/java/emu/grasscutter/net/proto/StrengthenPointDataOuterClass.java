...
public final class StrengthenPointDataOuterClass {
  ...
  public interface StrengthenPointDataOrBuilder extends
    ...
    /**
     * <code>uint32 base_point = 1;</code>
     * @return The basePoint.
     */
    int getBasePoint();

    /**
     * <code>uint32 cur_point = 2;</code>
     * @return The curPoint.
     */
    int getCurPoint();
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BASE_POINT_FIELD_NUMBER = 1;
    ...
    public static final int CUR_POINT_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (basePoint_ != 0) {
        output.writeUInt32(1, basePoint_);
      }
      if (curPoint_ != 0) {
        output.writeUInt32(2, curPoint_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (basePoint_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, basePoint_);
      }
      if (curPoint_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, curPoint_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nPointData\022\022\n\nbase_point\030\001 \001(\r\022\021\n\tcur_po" +
      "int\030\002 \001(\rB\033\n\031emu.grasscutter.net.protob\006" +
      "proto3"
    };
