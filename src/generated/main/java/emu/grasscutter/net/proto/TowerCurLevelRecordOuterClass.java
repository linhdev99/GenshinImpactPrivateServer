...
public final class TowerCurLevelRecordOuterClass {
  ...
  public interface TowerCurLevelRecordOrBuilder extends
    ...
    /**
     * <code>uint32 cur_floor_id = 1;</code>
     * @return The curFloorId.
     */
    int getCurFloorId();

    /**
     * <code>uint32 cur_level_index = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CUR_FLOOR_ID_FIELD_NUMBER = 1;
    ...
    public static final int CUR_LEVEL_INDEX_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (curFloorId_ != 0) {
        output.writeUInt32(1, curFloorId_);
      }
      if (curLevelIndex_ != 0) {
        output.writeUInt32(2, curLevelIndex_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (curFloorId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, curFloorId_);
      }
      if (curLevelIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, curLevelIndex_);
      }
      for (int i = 0; i < towerTeamList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ower_team_list\030\003 \003(\0132\n.TowerTeam\022\024\n\014buff" +
      "_id_list\030\004 \003(\r\022\020\n\010is_empty\030\005 \001(\010B\033\n\031emu." +
