...
public final class CombatInvocationsNotifyOuterClass {
  ...
  public interface CombatInvocationsNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .CombatInvokeEntry invoke_list = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    /**
     * Protobuf enum {@code CombatInvocationsNotify.CmdId}
     */
    public enum CmdId
      ...
      // @@protoc_insertion_point(enum_scope:CombatInvocationsNotify.CmdId)
    }

    public static final int INVOKE_LIST_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < invokeList_.size(); i++) {
        output.writeMessage(1, invokeList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < invokeList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, invokeList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nvokeEntry.proto\"\246\001\n\027CombatInvocationsNo" +
      "tify\022\'\n\013invoke_list\030\001 \003(\0132\022.CombatInvoke" +
