...
public final class ShortAbilityHashPairOuterClass {
  ...
  public interface ShortAbilityHashPairOrBuilder extends
    ...
    /**
     * <code>int32 ability_name_hash = 1;</code>
     * @return The abilityNameHash.
     */
    int getAbilityNameHash();

    /**
     * <code>int32 ability_config_hash = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (abilityNameHash_ != 0) {
        output.writeInt32(1, abilityNameHash_);
      }
      if (abilityConfigHash_ != 0) {
        output.writeInt32(2, abilityConfigHash_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (abilityNameHash_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(1, abilityNameHash_);
      }
      if (abilityConfigHash_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(2, abilityConfigHash_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "lityHashPair\022\031\n\021ability_name_hash\030\001 \001(\005\022" +
      "\033\n\023ability_config_hash\030\002 \001(\005B\033\n\031emu.gras" +
