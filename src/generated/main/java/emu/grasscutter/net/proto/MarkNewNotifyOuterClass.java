...
public final class MarkNewNotifyOuterClass {
  ...
  public interface MarkNewNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 mark_new_type = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum CmdId
       ...
       * <code>CMD_ID = 1212;</code>
       */
      public static final int CMD_ID_VALUE = 1212;
    ...
    public static final int MARK_NEW_TYPE_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (markNewType_ != 0) {
        output.writeUInt32(1, markNewType_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (markNewType_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, markNewType_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < idList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\025\n\rmark_new_type\030\001 \001(\r\022\017\n\007id_list\030\002 \003(\r\"" +
      "M\n\005CmdId\022\010\n\004NONE\020\000\022\023\n\017ENET_CHANNEL_ID\020\000\022" +
      "\024\n\020ENET_IS_RELIABLE\020\001\022\013\n\006CMD_ID\020\274\t\032\002\020\001B\033" +
