...
public final class QuestUpdateQuestVarReqOuterClass {
  ...
  public interface QuestUpdateQuestVarReqOrBuilder extends
    ...
    /**
     * <code>repeated .QuestVarOp quest_var_op_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int QUEST_VAR_OP_LIST_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < questVarOpList_.size(); i++) {
        output.writeMessage(2, questVarOpList_.get(i));
      }
      if (parentQuestId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < questVarOpList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, questVarOpList_.get(i));
      }
      if (parentQuestId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
